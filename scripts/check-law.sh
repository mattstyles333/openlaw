...
REQUIRED=(
  ...
  examples/fixtures/grok-bot-export/00-FREEZE.md
  examples/fixtures/grok-bot-export/README.md
  examples/fixtures/grok-bot-export/grok-bot/skills.md
  examples/fixtures/grok-bot-export/secrets-redacted.md
)
